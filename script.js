...
function playTrack(trackElement, index) {
    ...
    const trackArtist = trackElement.querySelector('.track-artist').textContent;
    const trackThumbnail = trackElement.querySelector('.track-thumbnail').src;
    
    // Update player
    document.querySelector('.player-track-name').textContent = trackName;
    document.querySelector('.player-artist-name').textContent = trackArtist;
    document.querySelector('.player-artwork').src = trackThumbnail;
    ...
    console.log(`Now playing: ${trackName} by ${trackArtist}`);
}
